...
# Added by Lars Wirzenius (liw@iki.fi):
# A third argument is optional.  If present, getopt.getopt works similar
# to the GNU getopt_long function (but optional arguments are not supported).
# The third argument should be a list of strings that name the long options.
# If the name ends '=', the argument requires an argument.
#
